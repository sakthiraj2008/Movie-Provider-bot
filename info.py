...
PICS = (environ.get('PICS', 'https://envs.sh/glg.jpg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://envs.sh/enD.jpeg")
MELCOW_VID = environ.get("MELCOW_VID", "https://envs.sh/eIV.jpeg")
...
STREAM_SITE = (environ.get('STREAM_SITE', 'linkmonetizer.in'))
STREAM_API = (environ.get('STREAM_API', '9fe420e18a3076d1f36afe3fcd7b81500310bf5f'))
STREAMHTO = (environ.get('STREAMHTO', 'https://t.me/quick_download_linkzz'))

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '1430742022').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002262171720').split()] #Channel id for auto indexing ( make sure bot is admin )
...
auth_channel = environ.get('AUTH_CHANNEL', ' -1002298937998') #Channel / Group Id for force sub ( make sure bot is admin )
...
# Verify/token system
VERIFY = bool(environ.get('VERIFY', Tue)) # Verification On ( True ) / Off ( False )
# HOWTOVERIFY = environ.get('HOWTOVERIFY', url='https://t.me/quick_download_linkzz') 
HOWTOVERIFY = environ.get('HOWTOVERIFY', 'https://t.me/quick_download_linkzz') # How to open tutorial link for verification
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+F0-m4r26aF5hNzll')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/tn_botz')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/quick_download_linkzz') # Tutorial video link for opening shortlink website 
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : TN BOTZ')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002318167392')) #Log channel id ( make sure bot is admin )
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+eBzYtdaY7Bc2ZDVl') #Support group link ( make sure bot is admin )
...
PROTECT_CONTENT = is_enabled((environ.get('PROTECT_CONTENT', "False")), Flse) #forwoding /sharing
...
if 'DYNO' in environ:
    ON_HEROKU = True
    APP_NAME = environ.get('Multi Filter')
else:
    ON_HEROKU = False
